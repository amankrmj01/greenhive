...
class Microcontroller extends amplify_core.Model {
  ...
  const Microcontroller._internal({required microcontrollerId, greenhouse, timestamp, temperature, humidity, co2, lightLevel, soilMoisture, modelRecommendation, actualFanSpeed, actualLightIntensity, fanStatus, fanSpeedSetting, lightStatus, lightIntensitySetting, waterPumpStatus, createdAt, updatedAt}): _microcontrollerId = microcontrollerId, _greenhouse = greenhouse, _timestamp = timestamp, _temperature = temperature, _humidity = humidity, _co2 = co2, _lightLevel = lightLevel, _soilMoisture = soilMoisture, _modelRecommendation = modelRecommendation, _actualFanSpeed = actualFanSpeed, _actualLightIntensity = actualLightIntensity, _fanStatus = fanStatus, _fanSpeedSetting = fanSpeedSetting, _lightStatus = lightStatus, _lightIntensitySetting = lightIntensitySetting, _waterPumpStatus = waterPumpStatus, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Microcontroller({required String microcontrollerId, Greenhouse? greenhouse, amplify_core.TemporalTimestamp? timestamp, double? temperature, double? humidity, double? co2, double? lightLevel, double? soilMoisture, String? modelRecommendation, double? actualFanSpeed, double? actualLightIntensity, MicrocontrollerFanStatus? fanStatus, int? fanSpeedSetting, MicrocontrollerLightStatus? lightStatus, int? lightIntensitySetting, MicrocontrollerWaterPumpStatus? waterPumpStatus}) {
  ...
  String toString() {
    ...
    buffer.write("lightLevel=" + (_lightLevel != null ? _lightLevel!.toString() : "null") + ", ");
    ...
    buffer.write("fanStatus=" + (_fanStatus != null ? amplify_core.enumToString(_fanStatus)! : "null") + ", ");
    buffer.write("fanSpeedSetting=" + (_fanSpeedSetting != null ? _fanSpeedSetting!.toString() : "null") + ", ");
    buffer.write("lightStatus=" + (_lightStatus != null ? amplify_core.enumToString(_lightStatus)! : "null") + ", ");
    buffer.write("lightIntensitySetting=" + (_lightIntensitySetting != null ? _lightIntensitySetting!.toString() : "null") + ", ");
    buffer.write("waterPumpStatus=" + (_waterPumpStatus != null ? amplify_core.enumToString(_waterPumpStatus)! : "null") + ", ");
  ...
  Microcontroller copyWith({Greenhouse? greenhouse, amplify_core.TemporalTimestamp? timestamp, double? temperature, double? humidity, double? co2, double? lightLevel, double? soilMoisture, String? modelRecommendation, double? actualFanSpeed, double? actualLightIntensity, MicrocontrollerFanStatus? fanStatus, int? fanSpeedSetting, MicrocontrollerLightStatus? lightStatus, int? lightIntensitySetting, MicrocontrollerWaterPumpStatus? waterPumpStatus}) {
    return Microcontroller._internal(
      microcontrollerId: microcontrollerId,
      ...
      lightIntensitySetting: lightIntensitySetting ?? this.lightIntensitySetting,
  ...
  Microcontroller copyWithModelFieldValues({
    ...
    return Microcontroller._internal(
      ...
      fanSpeedSetting: fanSpeedSetting == null ? this.fanSpeedSetting : fanSpeedSetting.value,
      lightStatus: lightStatus == null ? this.lightStatus : lightStatus.value,
      lightIntensitySetting: lightIntensitySetting == null ? this.lightIntensitySetting : lightIntensitySetting.value,
      waterPumpStatus: waterPumpStatus == null ? this.waterPumpStatus : waterPumpStatus.value
    );
  }
  ...
  Microcontroller.fromJson(Map<String, dynamic> json)  
    : _microcontrollerId = json['microcontrollerId'],
      ...
      _fanStatus = amplify_core.enumFromString<MicrocontrollerFanStatus>(json['fanStatus'], MicrocontrollerFanStatus.values),
      _fanSpeedSetting = (json['fanSpeedSetting'] as num?)?.toInt(),
      _lightStatus = amplify_core.enumFromString<MicrocontrollerLightStatus>(json['lightStatus'], MicrocontrollerLightStatus.values),
      _lightIntensitySetting = (json['lightIntensitySetting'] as num?)?.toInt(),
      _waterPumpStatus = amplify_core.enumFromString<MicrocontrollerWaterPumpStatus>(json['waterPumpStatus'], MicrocontrollerWaterPumpStatus.values),
      _createdAt = json['createdAt'] != null ? amplify_core.TemporalDateTime.fromString(json['createdAt']) : null,
      _updatedAt = json['updatedAt'] != null ? amplify_core.TemporalDateTime.fromString(json['updatedAt']) : null;
  
  Map<String, dynamic> toJson() => {
    'microcontrollerId': _microcontrollerId, 'greenhouse': _greenhouse?.toJson(), 'timestamp': _timestamp?.toSeconds(), 'temperature': _temperature, 'humidity': _humidity, 'co2': _co2, 'lightLevel': _lightLevel, 'soilMoisture': _soilMoisture, 'modelRecommendation': _modelRecommendation, 'actualFanSpeed': _actualFanSpeed, 'actualLightIntensity': _actualLightIntensity, 'fanStatus': amplify_core.enumToString(_fanStatus), 'fanSpeedSetting': _fanSpeedSetting, 'lightStatus': amplify_core.enumToString(_lightStatus), 'lightIntensitySetting': _lightIntensitySetting, 'waterPumpStatus': amplify_core.enumToString(_waterPumpStatus), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final FANSPEEDSETTING = amplify_core.QueryField(fieldName: "fanSpeedSetting");
  static final LIGHTSTATUS = amplify_core.QueryField(fieldName: "lightStatus");
  static final LIGHTINTENSITYSETTING = amplify_core.QueryField(fieldName: "lightIntensitySetting");
  static final WATERPUMPSTATUS = amplify_core.QueryField(fieldName: "waterPumpStatus");
