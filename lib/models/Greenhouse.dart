...
class Greenhouse extends amplify_core.Model {
  ...
  const Greenhouse._internal({required greenhouseId, name, cropName, cropTimePeriod, isActive, user, microcontroller, createdAt, updatedAt}): _greenhouseId = greenhouseId, _name = name, _cropName = cropName, _cropTimePeriod = cropTimePeriod, _isActive = isActive, _user = user, _microcontroller = microcontroller, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Greenhouse({required String greenhouseId, String? name, String? cropName, int? cropTimePeriod, bool? isActive, User? user, Microcontroller? microcontroller}) {
  ...
  Greenhouse copyWith({String? name, String? cropName, int? cropTimePeriod, bool? isActive, User? user, Microcontroller? microcontroller}) {
    return Greenhouse._internal(
      greenhouseId: greenhouseId,
      name: name ?? this.name,
  ...
  Map<String, dynamic> toJson() => {
    'greenhouseId': _greenhouseId, 'name': _name, 'cropName': _cropName, 'cropTimePeriod': _cropTimePeriod, 'isActive': _isActive, 'user': _user?.toJson(), 'microcontroller': _microcontroller?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
