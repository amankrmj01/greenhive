...
class Greenhouse extends amplify_core.Model {
  ...
  GreenhouseModelIdentifier get modelIdentifier {
    try {
      return GreenhouseModelIdentifier(greenhouseId: _greenhouseId!);
    } catch (e) {
  ...
  const Greenhouse._internal(
      ...
      : _greenhouseId = greenhouseId,
        _name = name,
        _cropName = cropName,
        _cropTimePeriod = cropTimePeriod,
        _isActive = isActive,
        _user = user,
  ...
  String toString() {
    ...
    buffer.write("cropTimePeriod=" +
        (_cropTimePeriod != null ? _cropTimePeriod.toString() : "null") +
        ", ");
  ...
  Greenhouse copyWithModelFieldValues(
    ...
    return Greenhouse._internal(
        ...
        cropTimePeriod:
            cropTimePeriod == null ? this.cropTimePeriod : cropTimePeriod.value,
  ...
  static final amplify_core.QueryModelIdentifier<GreenhouseModelIdentifier>
      MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<GreenhouseModelIdentifier>();
  static final GREENHOUSEID =
      amplify_core.QueryField(fieldName: "greenhouseId");
  static final NAME = amplify_core.QueryField(fieldName: "name");
  static final CROPNAME = amplify_core.QueryField(fieldName: "cropName");
  static final CROPTIMEPERIOD =
      amplify_core.QueryField(fieldName: "cropTimePeriod");
 ...
 */
class GreenhouseModelIdentifier
    implements amplify_core.ModelIdentifier<Greenhouse> {
  final String greenhouseId;

  /** Create an instance of GreenhouseModelIdentifier using [greenhouseId] the primary key. */
  const GreenhouseModelIdentifier({required this.greenhouseId});

  @override
  Map<String, dynamic> serializeAsMap() =>
      (<String, dynamic>{'greenhouseId': greenhouseId});
